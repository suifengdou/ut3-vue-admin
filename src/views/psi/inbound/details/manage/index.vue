              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    ...
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="入库单号" prop="order__code">
                        <el-input v-model="params.order__code" type="text" />
                      </el-form-item></el-col>
                      <el-col :span="6"><el-form-item label="仓库名" prop="warehouse__name">
                        <el-input v-model="params.warehouse__name" type="text" />
                      </el-form-item></el-col>
                      <el-col :span="6" />
                      <el-col :span="6" />
                    </el-row>
...
import {
  ...
  exportInboundDetail,
  getInboundDetail
} from '@/api/psi/inbound/details/manage'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getInboundDetail(this.params).then(
        res => {
