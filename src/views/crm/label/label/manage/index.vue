...
import {
  ...
  excelImportLabel,
  getLogLabel
} from '@/api/crm/labels/label/label'
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportLabel(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
