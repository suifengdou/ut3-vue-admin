...
<script>
import {
  getLabelCustomerOrderDetails,
  exportLabelCustomerOrderDetails,
  getLogLabelCustomerOrdeDetails,
 } from '@/api/crm/labels/labelorder/details/manage'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getLabelCustomerOrderDetails(this.params).then(
        res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportLabelCustomerOrderDetails(this.params).then(
              res => {
