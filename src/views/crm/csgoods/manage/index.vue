<template>
  <div class="customers-goods-container">
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="用户" prop="smartphone">
              <el-input v-model="formAdd.smartphone" placeholder="请输入用户" />
            </el-form-item></el-col>
            <el-col :span="6"><el-form-item label="货品" prop="goods">
              <el-select
                ...
                remote
                reserve-keyword
                placeholder="请搜索并选中货品"
                :remote-method="remoteMethodLabelGoods"
              >
                <el-option
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="SN" prop="sn">
              <el-input v-model="formAdd.sn" placeholder="请输入SN" />
            </el-form-item></el-col>
            <el-col :span="6"><el-form-item label="购买日期" prop="purchase_time">
              <el-date-picker
...
export default {
  ...
  methods: {
    ...
    handleSubmitAdd() {
      ...
      createCSGoods(this.formAdd).then(
        () => {
          this.$notify({
            title: '创建成功',
            type: 'success',
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportCSGoods(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            instance.confirmButtonLoading = true
            instance.confirmButtonText = '执行中...'
            exportCSGoods(this.params).then(
              res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectCSGoods(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '取消成功',
