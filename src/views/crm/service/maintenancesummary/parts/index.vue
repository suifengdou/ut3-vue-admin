...
<script>
import {
  getMaintenancePartSummary,
  exportMaintenancePartSummary,
  checkMaintenancePartSummary,
  getLogMaintenancePartSummary
} from '@/api/crm/service/maintenancesummary/part'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getMaintenancePartSummary(this.params).then(
        res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportMaintenancePartSummary(this.params).then(
              res => {
                console.log(res)
    ...
    handleCheck() {
      ...
      if (this.params.allSelectTag === 1) {
        checkMaintenancePartSummary(this.params).then(
          res => {
    ...
    logView(userValue) {
      ...
      getLogMaintenancePartSummary(data).then(
        res => {
          this.$notify({
            title: '查询成功',
            type: 'success',
