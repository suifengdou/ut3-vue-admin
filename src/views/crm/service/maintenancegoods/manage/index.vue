<template>
  <div class="maintenance-goods-manage-container">
...
<script>
import {
  getLogMaintenanceGoods,
  getMaintenanceGoods,
  exportMaintenanceGoods
} from "@/api/crm/service/maintenancegoods/manage"
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getMaintenanceGoods(this.params).then(
        res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportMaintenanceGoods(this.params).then(
              res => {
                console.log(res)
