<template>
  <div class="customers-address-container">
    <div class="tableTitle">
      <el-row :gutter="20">
        ...
        <el-col :span="5" class="titleBar">
          <div class="grid-content bg-purple">
            <el-tooltip class="item" effect="dark" content="支持多个电话" placement="top-start">
              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    ...
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="收货信息" prop="name">
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="用户电话" prop="smartphone">
              <el-input v-model="formAdd.smartphone" placeholder="请输入客户手机" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="16"><el-form-item label="收件信息" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入收件信息" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
        ...
        <div class="handleFormEdit">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                <el-col :span="16"><el-form-item label="收件信息" prop="name">
                  <el-input v-model="formEdit.name" placeholder="请输入收件信息" />
                </el-form-item></el-col>
              </el-row>
                <el-row :gutter="20">
                  <el-col :span="16"><el-form-item label="备注" prop="memo">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        name: [
          { required: true, message: '请输入用户收件信息', trigger: 'blur' }
        ]
      },
      checkedDetail: [],
      checkedDetailEdit: []
  ...
  methods: {
    ...
    handleSubmitAdd() {
      ...
      createCSAdress(this.formAdd).then(
        () => {
          this.$notify({
            title: '创建成功',
            type: 'success',
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportCSAdress(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            instance.confirmButtonLoading = true
            instance.confirmButtonText = '执行中...'
            exportCSAdress(this.params).then(
              res => {
    ...
    handleCheck() {
      ...
      if (this.params.allSelectTag === 1) {
        checkCSAdress(this.params).then(
          res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectCSAdress(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '取消成功',
