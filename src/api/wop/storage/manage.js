...
export function updateWorkOrderManage(id, data) {
  ...
  return request({
    url: `/workorder/storage/swomanage/${id}/`,
    method: 'patch',
    data
  })
}
...
export function excelImportWorkOrderManage(data) {
  return request({
    url: `/workorder/storage/swomanage/excel_import/`,
    method: 'post',
    data
  })
}
...
export function checkWorkOrderManage(data) {
  return request({
    url: `/workorder/storage/swomanage/check/`,
    method: 'patch',
    data
  })
}
...
export function rejectWorkOrderManage(data) {
  return request({
    url: `/workorder/storage/swomanage/reject/`,
    method: 'patch',
    data
  })
}
